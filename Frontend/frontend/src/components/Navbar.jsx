    ...
    <nav className="relative w-full h-17.5 bg-white border-b shadow-sm px-5 md:px-8 flex items-center justify-between">
      ...
      <div className="hidden md:block relative">
        ...
        >
          ...
          {/* <img src="/logo.png" alt="profile" className="w-12 h-12 rounded-full object-cover" /> */}
          <span>Account</span>
          <MdKeyboardArrowDown
        ...
        {isAccountOpen && (
          <div
            ...
            <Link
              ...
              className="  block  px-4  py-2.5  hover:bg-gray-100 "> Admin
            </Link>
      ...
      {isMenuOpen && (
        <div
          ...
          <Link
            ...
            <MdEditNote className="text-2xl" /> Write
          </Link>

          <Link
            to="/account"
            onClick={() => setIsMenuOpen(false)}
            className=" px-3 py-3 rounded-lg hover:bg-gray-100"> Admin</Link>
          ...
          <button
            onClick={() => setIsMenuOpen(false)}
            className=" text-left px-3 py-3 rounded-lg text-red-500  hover:bg-red-50 " > Delete Account </button>
