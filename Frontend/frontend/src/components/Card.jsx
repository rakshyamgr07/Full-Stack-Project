...
const Card = ({item}) => {
    return (
        <Link to={`/post/${item.postId}`} className="p-4 bg-white border border-gray-200 hover:-translate-y-1 transition duration-300 rounded-lg shadow shadow-black/10 max-w-80">
